...
<div class="card shadow-sm">
    <div class="col-md-12 bg-primary py-1 text-white">
        <div class="row px-2">
            <h3>
                ...
                จัดการบทเรียนรายวิชา - {{$data->course_id}} - {{$data->course_name}} -  {{$lesson->lesson_name}} - บันทึกย่อของสมาชิก องค์กร <b>{{$data_org->org_name}}</b>
            </h3>
            <div class="ml-auto">
                    <div class="dropdown">
    ...
    <div class="card-body">
        <table class="table table-vertical-center">
            <tr>
                @if ( $send_note == null)
                   <h3>ระบบตรวจสอบเเล้วไม่พบบันทึกย่อของสมาชิกที่อยู่องค์กรใน <b>{{$data_org->org_name}}</b> </h3>
                @else
                <th>
