            ...
            <div class="col-md-2">
                <div class="card  mt-3 shadow-sm">
                    <div class="col-md-12 bg-primary text-white">
                        <h3>เมนูสำหรับบทเรียน</h3>
                    </div>
                    <ul class="navbar-nav px-3">
                        <li class="nav-item">
                            <div class="nav-item dropdown">
                                {{--{{route('pages.page_send_note',$lesson->lesson_id)}}--}}
                                <a href="#" class="nav-link dropdown ">
                                    <h4><i class='bx bxs-book-open'></i> ดูบันทึกย่อ</h4>
                                </a>
                                <a href="{{route('set.quiz',$lesson->lesson_id)}}" class="nav-link dropdown ">
                                    <h4><i class='bx bxs-book-open'></i> สร้างชุดแบบทดสอบ</h4>
                                </a>
                                <a href="#" class="nav-link dropdown ">
                                    <h4><i class='bx bxs-book-heart' ></i> จัดการคะเเนน</h4>
                                </a>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav px-3">
                        <li class="nav-item">
                            <div class="nav-item dropdown">
                                ...
                                <a href="#" class="nav-link dropdown ">
                                    <h4><i class='bx bxs-book-open'></i> ดูแบบทดสอบ</h4>
                                </a>
                                <a href="#" class="nav-link dropdown ">
                ...
                <div class="card  mt-3 shadow-sm">
                    <div class="col-md-12 bg-primary text-white">
                        <h3>บทเรียนเพิ่มเติม</h3>
                    </div>
                    <ul class="navbar-nav p-3">
                        <li class="nav-item">
                            <div class="nav-item dropdown">
                                @foreach ($lesson_all as $row)
                                <a href="{{route('pages.lesson_page',$row->lesson_id)}}" class="text-dark">
                                    <h4>{{$row->lesson_name}}</h4>
                                </a>
                                @endforeach
                            </div>
                        </li>
