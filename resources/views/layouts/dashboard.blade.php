                        ...
                        <li class="nav-item">
                            <div class="nav-item dropdown">
                                ...
                                <a href="{{route('pages.org_my_join')}}" class="nav-link dropdown ">
                                    <h4><i class='bx bxs-group'></i> องค์กรที่ฉันเข้าร่วม({{$co_my_course}})</h4>
                                </a>
                                <a href="{{route('page.my_course')}}" class="nav-link dropdown ">
                                    <h4><i class='bx bxs-book'></i> รายวิชาที่ฉันลงทะเบียน({{$co_org_myjoin}})</h4>
                                </a>
